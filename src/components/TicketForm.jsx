            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-700">
              {rows.map((row, idx) => (
                <tr key={row.id} className="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                  ...
                  <td className="px-2 py-2">
                    <Select className="h-9" value={row.serviceType} onChange={e => updateRow(idx, 'serviceType', e.target.value)} options={SERVICE_TYPES['General']} />
                  </td>
                  <td className="px-2 py-2">
                  ...
                  <td className="px-2 py-2">
                    <Select className="h-9" value={row.workzone} onChange={e => updateRow(idx, 'workzone', e.target.value)} options={['-', ...WORKZONES.BANDUNG]} />
                  </td>
                  <td className="px-2 py-2">
